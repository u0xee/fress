= image:banner-io.svg[fress,260] image:bars.svg[menu,50,float="right",link="#toc"]
:toc: macro
:title: fress.io
...
[.out-links]
image:book.svg[thesis,40] Jump to link:thesis.html[my thesis]
[.out-links]
image:notes.svg[notation,40] Learn information *notation* https://www.fress.in[fress.in]
[.out-links]
image:dev.svg[dev,40] Find developer resources https://www.fress.dev[fress.dev]
