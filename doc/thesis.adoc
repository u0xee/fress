...
======
Imagine if every time you turned on the lights, your television turned off (#FirstWorldProblems).
...
With the exception of NASA, it just doesn't make sense to plan that far ahead.
...
Link to section.
<<simple>> is a great section!!
And a citation to the bibliography <<Ackerman-Diss>>, as you can see `Value` is a code name.
...
[NOTE]
====
A note called out from the regular text flow. This should be your motto for systematic detection and evaluation of risks and technical debts in the architecture, which will be needed by management stakeholders.
====

TIP: Here's a tip. This should be your motto for systematic detection and evaluation of risks and technical debts in the architecture, which will be needed by management stakeholders.

WARNING: Here's a warning. This should be your motto for systematic detection and evaluation of risks and technical debts in the architecture, which will be needed by management stakeholders.

IMPORTANT: Here's an important. This should be your motto for systematic detection and evaluation of risks and technical debts in the architecture, which will be needed by management stakeholders.

CAUTION: Here's a caution. This should be your motto for systematic detection and evaluation of risks and technical debts in the architecture, which will be needed by management stakeholders.
