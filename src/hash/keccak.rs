...
//! The Keccak hash, supports SHA3 and KangarooTwelve
//! Starts with the permutation, which is a repetition of rounds.
//! Then defines state machines for SHA and K12 hashing
